...
namespace Ocean.Core.BrowserDetective.UnitTests
{
    ...
    public class Results2017
    {
        ...
        public void Setup()
        {
            if (System.IO.File.Exists("Data/Core.Results.2017.db"))
            {
                //PreGenerated Results for 2024, so we can compare against
                resultContext = new Ocean.Core.BrowserDetective.Data.Context.ResultContext($"Data Source=Data/Core.Results.2017.db");
            }

            //Headers captured in 2024
            Headercontext = new Ocean.Core.BrowserDetective.Data.Context.HeaderContext($"Data Source=Data/Headers2017.DB");
        ...
        [Test]
        public void GenericBrowser2017()
        {
            System.Collections.Generic.Dictionary<long, string> FailedTest = new Dictionary<long, string>();
            int Failed = 0;
            //Only really care about the headers actually used in the Results table.
