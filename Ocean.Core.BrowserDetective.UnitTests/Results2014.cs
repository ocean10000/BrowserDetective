...
namespace Ocean.Core.BrowserDetective.UnitTests
{
    ...
    public class Results2014
    {
        ...
        public void Setup()
        {
            if (System.IO.File.Exists("Data/Core.Results.2014.db"))
            {
                //PreGenerated Results for 2024, so we can compare against
                resultContext = new Ocean.Core.BrowserDetective.Data.Context.ResultContext($"Data Source=Data/Core.Results.2014.db");
            }

            //Headers captured in 2024
            Headercontext = new Ocean.Core.BrowserDetective.Data.Context.HeaderContext($"Data Source=Data/Headers2014.DB");
